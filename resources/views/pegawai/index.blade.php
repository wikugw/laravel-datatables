...
<body>
    <div class="container mt-2">
        <div class="card">
            ...
            <div class="card-body">
                <a href="javascript:void(0)" class="mb-3 btn btn-info" id="tombol-tambah">Tambah PEGAWAI</a>
                <table id="table_pegawai" class="table table-striped table-sm table-bordered">
                    <thead>
                        <tr>
                            <th>Nama</th>
                            <th>Jenis Kelamin</th>
